...
contract("ColonyNetworkMining", accounts => {
  ...
  describe("Misbehaviour during dispute resolution", () => {
    it("should prevent a user from confirming a JRH they can't prove is correct", async () => {
      ...
      await checkErrorRevert(
        repCycle.confirmJustificationRootHash(round.toString(), index.toString(), "123456", siblings1, branchMask2.toString(), siblings2, {
          gasLimit: 6000000
        }),
      ...
      await checkErrorRevert(
        repCycle.confirmJustificationRootHash(round.toString(), index.toString(), branchMask1.toString(), siblings1, "123456", siblings2, {
          gasLimit: 6000000
        }),
